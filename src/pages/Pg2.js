...
class Pg2 extends React.Component {
  ...
  componentDidMount() {
    ...
    setTimeout(() => {
      ...
      this.props.addClient({ name: "zzzzssszzz" });
    }, 10000);
    ...
    fetch(URL_TO_FETCH, {
      ...
      this.props.addClient({ name: "Aryal" });
    });
  }
  ...
  render() {
    return <Comp1 clients={this.props.clients.clients} onAdd={this.onAdd} />;
  }
}
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(Pg2));
